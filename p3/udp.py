...
def process_UDP_datagram(us,header,data,srcIP):
    ...
    logging.debug("informacion del paquete: " + str(data[8:(struct.unpack('!h',length)[0])]))
    logging.debug("datagrama udp: " + str(data[:(struct.unpack('!h',length)[0])]))
